...
Auth.create = (newUser, callback) => {
  dbConnect.query(`INSERT INTO users (pseudo, lastname, firstname, email, password, picture, isAdmin) VALUES (?,?,?,?,?,?,?)`, [newUser.pseudo, newUser.lastname, newUser.firstname, newUser.email, newUser.password, newUser.pictures, newUser.isAdmin], (err, results) => {
